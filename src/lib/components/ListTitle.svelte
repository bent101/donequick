...
<input
	...
	class="w-80 min-w-min overflow-clip overflow-ellipsis rounded-full border-2 border-transparent bg-transparent px-4 text-lg font-bold text-neutral-500 outline-0 enabled:border-neutral-200 enabled:hover:border-neutral-300 enabled:focus:border-blue-500 dark:text-neutral-400 dark:enabled:border-neutral-700 dark:enabled:hover:border-neutral-600 dark:enabled:focus:border-blue-500"
/>
